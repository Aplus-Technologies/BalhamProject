...
namespace BalhamCollege
{
    public partial class EnterResultForm : Form
    {
        ...
        private void dgvAssessments_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dgvAssessments.DefaultCellStyle.SelectionBackColor = SystemColors.Highlight;
                ...
                else
                {
                    try
                    {
                        ...
                        else if (dialogResult == DialogResult.No)
                        {
                            ...
                            LoadAssessments();
                            initCount = 0;
                            // Application.OpenForms["CourseBackgroundForm"].Close(); // to close the background form
                            frmCourseAdministrator.Show();
